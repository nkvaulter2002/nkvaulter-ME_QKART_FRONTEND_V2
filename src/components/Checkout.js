  ...
  return (
    <Box display="flex" flexDirection="column">
      ...
      <Stack direction="row" my="1rem">
        ...
        <Button variant="text" onClick={()=>handleNewAddress({...newAddress,isAddingNewAddress:false})}>Cancel</Button>
      </Stack>
    </Box>
  );
};
                ...
                addresses.all.map((address) => {
                  return (
                    ...
                    >
                      ...
                      <Button onClick={()=>{deleteAddress(token,address._id)}} startIcon={<Delete />}>
                        Delete
                      </Button>
                    </Box>
                  );
